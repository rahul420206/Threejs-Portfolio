...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description: [
      "Working on AI- and data-driven products, contributing to the development of scalable and intelligent enterprise applications.",
      "Collaborating with cross-functional teams to understand data pipelines, model integrations, and system architecture.",
      "Actively involved in frontend and backend feature development while ramping up on cloud-based and AI-focused workflows."
    ],
    technologies: ["Microsoft Azure", "C#", "React", ".NET Core", "TypeScript", "AI/ML"]
  },
  {
    company: "Codetru",
    role: "Software Intern",
    period: "Apr 2025 – November 2025",
    description: [
